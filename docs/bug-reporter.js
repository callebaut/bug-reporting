  ...
  var BugReporter = (function () {
    ...
    function buildMarkdown(c, imageNote) {
      ...
      if (c.cookies !== undefined) {
        ...
        L.push('');
        if (Object.keys(c.localStorage).length) {
          L.push('## localStorage');
          L.push(fence(JSON.stringify(c.localStorage, null, 2), 'json'));
          L.push('');
        }
        if (Object.keys(c.sessionStorage).length) {
    ...
    function buildHtml(c, imgDataUrl) {
      ...
      if (c.cookies !== undefined) {
        ...
        if (Object.keys(c.localStorage).length) pre('localStorage', c.localStorage);
        if (Object.keys(c.sessionStorage).length) pre('sessionStorage', c.sessionStorage);
      }
